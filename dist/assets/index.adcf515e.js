var Se=Object.defineProperty,we=Object.defineProperties;var Ce=Object.getOwnPropertyDescriptors;var Y=Object.getOwnPropertySymbols;var Pe=Object.prototype.hasOwnProperty,Ee=Object.prototype.propertyIsEnumerable;var ee=(a,t,s)=>t in a?Se(a,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):a[t]=s,w=(a,t)=>{for(var s in t||(t={}))Pe.call(t,s)&&ee(a,s,t[s]);if(Y)for(var s of Y(t))Ee.call(t,s)&&ee(a,s,t[s]);return a},D=(a,t)=>we(a,Ce(t));import{s as P,S as re,r as p,j as r,a as e,N as te,B as N,D as ke,b as Fe,F as z,c as I,I as De,P as Le,d as _e,u as ae,e as oe,C as A,f as F,g as y,h as ie,M as Ie,O as Ae,i as Te,R as T,T as Re,k as je,l as Oe,m as O,n as Me,o as se,p as $e,q as Ue,t as qe,v as He,w as R,x as Be,E as ze}from"./vendor.bc8296ee.js";const Ge=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))c(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const d of i.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&c(d)}).observe(document,{childList:!0,subtree:!0});function s(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerpolicy&&(i.referrerPolicy=o.referrerpolicy),o.crossorigin==="use-credentials"?i.credentials="include":o.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function c(o){if(o.ep)return;o.ep=!0;const i=s(o);fetch(o.href,i)}};Ge();const Je=P.div`
  display: flex;
  align-items: center;
...
`,V=({logo:a,brandTitle:t,logoSize:s,links:c,customMenu:o,additionalItem:i})=>{const d=b=>b.map((u,h)=>e(te,{to:u.route,children:r("li",{children:[e("i",{className:u.icon||""}),u.label]})},h)),[g,v]=p.exports.useState(!1),l=()=>r("div",{children:[e(N,{icon:"pi pi-bars",onClick:()=>v(!0),className:"p-mr-2"}),e(We,{visible:g,fullScreen:!0,onHide:()=>v(!1),children:r("ul",{children:[r("h2",{children:[e(ne,{src:a,size:s}),"Genios"]}),d(c)||""]})})]});return r(Je,{children:[r("div",{className:"brand",children:[e("a",{href:"/",children:e(ne,{src:a,size:s})}),e("h3",{children:t||""})]}),e("ul",{children:c?d(c):""}),e("div",{className:"custom-children",children:o||l()}),i||""]})},Ve=P.div`
  display: grid;
  place-items: center;
...
`,ir=({name:a,price:t,image:s,data:c})=>r(or,{onClick:d=>{d.detail=c.id,Q("productDetail:click",d.detail)},className:"card-container",image:s,children:[e("div",{className:"product-card__image"}),r("div",{className:"product-info",children:[r("div",{children:[e("h2",{className:"product-name",children:a}),r("p",{className:"product-price",children:[e("strong",{children:"Price: "}),t]})]}),e(N,{icon:"pi pi-plus",className:"add-cart p-button-rounded",onClick:d=>{d.stopPropagation();const g=d.target.closest(".add-cart");Fe(g,{transform:["scale(1.1)","scale(1)"]},{duration:.4}),d.detail={id:c.id,image:c.foto,name:c.nombre,price:c.precio,description:c.descripcion,reference:c.referencia,category:c.categoria,dimensions:c.dimensiones},Q("addProduct:click",d.detail)}})]})]}),sr=P.div`
  padding: 1rem;
  display: grid;
