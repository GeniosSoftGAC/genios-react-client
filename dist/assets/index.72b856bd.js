...
`,tr=({name:a,price:t,image:s,data:c})=>r(rr,{onClick:d=>{d.detail=c.id,Q("productDetail:click",d.detail)},className:"card-container",image:s,children:[e("div",{className:"product-card__image"}),r("div",{className:"product-info",children:[r("div",{children:[e("h2",{className:"product-name",children:a}),r("p",{className:"product-price",children:[e("strong",{children:"Price: "}),t]})]}),e(v,{icon:"pi pi-plus",className:"add-cart p-button-rounded",onClick:d=>{d.stopPropagation();const n=d.target.closest(".add-cart");Pe(n,{transform:["scale(1.1)","scale(1)"]},{duration:.4}),d.detail={id:c.id,image:c.foto,name:c.nombre,price:c.precio,description:c.descripcion,reference:c.referencia,category:c.categoria,dimensions:c.dimensiones},Q("addProduct:click",d.detail)}})]})]}),ar=S.div`
  padding: 1rem;
  display: grid;
